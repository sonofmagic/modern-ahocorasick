...
expectType<Match<{ id: string }> | undefined>(matcher.findFirst('she', options))
expectType<Match<{ id: string }> | undefined>(matcher.findAt('she', 0, options))
...
expectType<string>(matcher.serializeArtifact())
expectType<AhoCorasick<unknown>>(AhoCorasick.deserialize(matcher.serialize()))
expectType<AhoCorasick<unknown>>(AhoCorasick.deserializeArtifact(matcher.serializeArtifact()))
