...
The package supports CommonJS and ESM and includes TypeScript declarations.
Matching uses `Intl.Segmenter`; match positions are zero-based grapheme-cluster indices.
